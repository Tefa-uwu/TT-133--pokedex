...
//Para mostrar el nombre del pokemon
 ...
 function showPokemonDetail (pokemon){
    ...
    let movesToPrint= ""
                        //Establezco el evento moves
    pokemon.moves.forEach(moves => {
        //Aqui esta almacenando los moves para mostrarlos todos
                                                        //Dentro del evento moves hay un move donde estan los name de los movimientos
